...
class LoginFrame(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self, text=" ", font=20).pack()
        button1= Button(self, text="LOGIN", font=("Code-Light", 20), background="Black", foreground="White", command=self.login1).pack(side=TOP)
        Label(self, text=" ", font=("Century Gothic", 20)).pack(side="top")
        button2 = Button(self, text="Exit Dekstop", font=("Century Gothic", 10), background="Black", foreground="White",
...
class MainFrame(Frame):
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        x = Font(family="Consolas", size=17)
        Label(self, text="What Do You Want ?", width=20, font=x).pack(side="top")
        Button(self, text='Search Item', width=20, font=x, command=lambda: controller.show_frame("Search")).pack(side=TOP)
        Button(self, text="Show all Item", width=20, font=x, command= lambda: controller.show_frame("ShowAll")).pack(side=TOP)
        Button(self, text="Input Item", width=20, font=x, command=lambda: controller.show_frame("InputItem")).pack(
            side=TOP)
        Button(self, text="Delete Item", width=20, font=x, command=lambda: controller.show_frame("DeleteItem")).pack(
            side=TOP)
        Button(self, text="Item [OUT]", width=20, font=x, command=lambda: controller.show_frame("BarangKeluar")).pack(
            side=TOP)
        Button(self, text="Item [IN]", width=20, font=x, command=lambda: controller.show_frame("BarangMasuk")).pack(
            side=TOP)
        Button(self, text='EXIT', width=20, command=self.quit).pack(side=BOTTOM)
        Button(self, text='Sign Out', width=20, command=lambda: controller.show_frame("LoginFrame")).pack(side=BOTTOM)
...
class Search(Frame):
    def __init__(self, parent, controller):
        ...
        button2 = Button(self, text='Back', width=15, font="Consolas", command=self.back).pack(side=BOTTOM)
        ...
        self.button1 = Button(self, text="Search", font="Consolas",
...
class ShowAll(Frame):
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        button2=Button(self, text="Back", width=20, font="Consolas", command=self.back).pack(side=BOTTOM)
        self.kotak1=Text(master=self, width=160)
        self.kotak1.pack(side=BOTTOM)
        self.option = StringVar()
        self.option.set('')
        Label(self, text='Sort By', width=20, font="Consolas").pack(side=TOP)
        option = OptionMenu(self, self.option, "ID", "Brand", "Kategori", "Nama", "Lokasi", "Stok").pack(side=TOP)
        button1=Button(self, text="PRINT!!", width=20, font="Consolas", command=self.show).pack(side='top')
...
class InputItem(Frame):
    def __init__(self, parent, controller):
        ...
        #self.myvar1 = StringVar()
        Button(self, text="Back", width=20, font="Consolas",
    ...
    def initUI(self):
        ...
        frame1.pack(fill=X)
        self.myvar1=StringVar()
        Label(frame1, text='ID :', font=("Consolas", 15), width=12, justify="left").pack(side=LEFT, padx=12, pady=7)
        self.entry1=Entry(frame1, width=20, font=("Consolas", 15), textvariable=self.myvar1)
        self.entry1.pack(fill=X, padx=7,ipadx=30, expand=True)
        frame2 = Frame(self)
        frame2.pack(fill=X)
        self.myvar2 = StringVar()
        Label(frame2, text='Brand :', font=("Consolas", 15), width=12, ).pack(side=LEFT, padx=12, pady=7)
        self.entry2=Entry(frame2, width=20, font=("Consolas", 15), textvariable=self.myvar2)
        self.entry2.pack(fill=X, padx=7,ipadx=30, expand=True)
        frame3 = Frame(self)
        frame3.pack(fill=X)
        self.myvar3 = StringVar()
        Label(frame3, text='Kategori :', font=("Consolas", 15), width=12).pack(side=LEFT, padx=12, pady=7)
        self.entry3=Entry(frame3, width=20, font=("Consolas", 15), textvariable=self.myvar3)
        self.entry3.pack(fill=X, padx=7,ipadx=30, expand=True)
        frame4 = Frame(self)
        frame4.pack(fill=X)
        self.myvar4 = StringVar()
        Label(frame4, text='Nama :', font=("Consolas", 15), width=12).pack(side=LEFT, padx=12, pady=7)
        self.entry4=Entry(frame4, width=20, font=("Consolas", 15), textvariable=self.myvar4)
        self.entry4.pack(fill=X, padx=7,ipadx=30, expand=True)
        frame5 = Frame(self)
        frame5.pack(fill=X)
        self.myvar5 = StringVar()
        Label(frame5, text='Lokasi :', font=("Consolas", 15), width=12).pack(side=LEFT, padx=12, pady=7)
        self.entry5=Entry(frame5, width=20, font=("Consolas", 15), textvariable=self.myvar5)
        self.entry5.pack(fill=X, padx=7,ipadx=30, expand=True)
        frame6 = Frame(self)
        frame6.pack(fill=X)
        self.myvar6 = StringVar()
        Label(frame6, text='Stok :', font=("Consolas", 15), width=12).pack(side=LEFT, padx=12, pady=7)
        self.entry6=Entry(frame6, width=20, font=("Consolas", 15), textvariable=self.myvar6)
        self.entry6.pack(fill=X, padx=7,ipadx=30, expand=True)
        Button(self, text="PROCESS", width=20, font="Consolas",
...
class BarangKeluar(Frame):
    ...
    def initUI(self):
        ...
        frame2.pack(fill=X)
        self.myvar2 = StringVar()
        Label(frame2, text='Item [OUT] :', font=("Consolas", 15), width=12, ).pack(side=LEFT, padx=12, pady=7)
        self.entry2 = Entry(frame2, width=20, font=("Consolas", 15), textvariable=self.myvar2)
        self.entry2.pack(fill=X, padx=7, ipadx=30, expand=True)
        Button(self, text="PROCESS", width=20, font="Consolas",
               command=self.search12).pack(
...
class BarangMasuk(Frame):
    ...
    def initUI(self):
        ...
        frame2.pack(fill=X)
        self.myvar2 = StringVar()
        Label(frame2, text='Item [IN] :', font=("Consolas", 15), width=12, ).pack(side=LEFT, padx=12, pady=7)
        self.entry2 = Entry(frame2, width=20, font=("Consolas", 15), textvariable=self.myvar2)
        self.entry2.pack(fill=X, padx=7, ipadx=30,expand=True)
        Button(self, text="PROCESS", width=20, font="Consolas",
               command=self.search12).pack(
